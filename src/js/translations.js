...
inverted_wordles.languages = {
    ...
    fr: {
        ...
        "answer_wordle_question": "Répondre à une question sur les nuages de mots",
        "menu": "menu",
        ...
        "speak_wordle": "Prononcez le texte wordle sous le pointeur",
        "apply_weight": "Appliquer la pondération conventionnelle",
        "error_voiceover": "*Impossible d'activer VoiceOver. La version ou la configuration de votre navigateur ne prend pas en charge l'API vocale Web.*",
        "confirm_delete": "Confirmer pour supprimer",
        "confirm_delete_detail": "Cela supprimera définitivement le lien de la question et vous ne pourrez plus voir les réponses ou le jeu de mots. Êtes-vous sûr de vouloir supprimer le lien?",
        ...
        "error_answer_submit": "Il y a un problème pour soumettre votre réponse. Veuillez réessayer plus tard.",
        ...
        "error_create_wordle": "Erreur lors de la création d'un nouveau nuage de mots: ",
